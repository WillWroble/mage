...
public final class TestComputerPlayerMonteCarlo2 extends ComputerPlayerMCTS2 {

    private TestPlayer testPlayerLink;

    public TestComputerPlayerMonteCarlo2(String name, RangeOfInfluence range, int skill) {
