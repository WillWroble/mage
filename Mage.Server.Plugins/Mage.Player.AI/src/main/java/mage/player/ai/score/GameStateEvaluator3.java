...
public final class GameStateEvaluator3 {
    ...
    private static final Logger logger = Logger.getLogger(GameStateEvaluator3.class);

    public static final int WIN_GAME_SCORE = 100000000;
    public static final int LOSE_GAME_SCORE = -WIN_GAME_SCORE;

    public static final int HAND_CARD_SCORE = 250;
    ...
    public static void printBattlefield(Game game, UUID playerId) {
        // hand
        Player player = game.getPlayer(playerId);
        GameStateEvaluator3.PlayerEvaluateScore score = GameStateEvaluator3.evaluate(playerId, game);
        ...
        String cardsInfo = player.getHand().getCards(game).stream()
                .map(card -> card.getName() + ":" + GameStateEvaluator3.HAND_CARD_SCORE) // TODO: add card score here after implement
        ...
        String ownPermanentsInfo = game.getBattlefield().getAllPermanents().stream()
                ...
                .map(p -> p.getName()
                        ...
                        + ":" + GameStateEvaluator3.evaluatePermanent(p, game, true))
                .collect(Collectors.joining("; "));
